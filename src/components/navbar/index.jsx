...
const Navbar = () => {
  {/*toggle handler for closing and opening sidebar*/ }
  ...
  {/*Declaration of Array for Socail icons*/ }
  const socialLinks = [
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {/* mane items in side menu bar drawer */}
              {/* an arrow fucntion is used to to insert values of object of array in ListItem with map method  */}
              {menuItems.map((item, index) => ( 
                <ListItem
                key={index}
                component={Link} 
                to={item.link} 
                  /* this arrow fucntion force the menues to load page form teh starts of the page */
                  onClick={() => {
                    if (!item.link.startsWith("#")) { 
                      window.scrollTo(0, 0); // Ensure it scrolls to the top
                    } else {
                      handleScroll(item.link.substring(1)); // Handle in-page scrolling , substring will remove the first charcter form item in link object
                    }
                  }}
                  target={item.target}
                  button
                ...
                >
                  {/* menu items icons before menu text  */}
                  <ListItemIcon
                    sx={{
                      padding: "0px",
                      minWidth: "46px",
          ...
          {/* follow me section in side menu bar drawer */}
          <Stack>
            ...
            {/* an arrow fucntion is used to to insert values of object of array in IconButton with map method  */}
